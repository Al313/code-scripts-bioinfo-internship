...
sampleID <- args[1]
# path_to_vcf <- paste0("/home/ali313/Documents/studies/master/umc-project/hpc/cuppen/shared_resources/HMF_data/DR-104-update3/", 
#                       "somatics/200706_HMFregCPCT_FR16615415_FR17038019_CPCT02070491/purple/CPCT02070491T.purple.somatic.vcf.gz")


# path_to_vcf_failed_job <- paste0("/home/ali313/Documents/studies/master/umc-project/hpc/cuppen/shared_resources/HMF_data/DR-104-update3",
                                 # "/somatics/170622_HMFregCPCT_FR13256292_FR13256012_CPCT02050166/purple/CPCT02050166T.purple.somatic.vcf.gz")
path_to_vcf <- args[2]
tadBedFileInput <- args[3]
binBedFileInput <- args[4]
repTimingFileInput <- args[5]
repTimingFileInputBoxtel <- args[6]
cpgInputFile <- args[7]
repOrientationInputFile <- args[8]
# out_dir <- "/home/ali313/Documents/studies/master/umc-project/data/all-annotation"
out_dir <- args[9]
...
# tadBedFileInput <- "/home/ali313/Documents/studies/master/umc-project/data/reproducing-fig-3a/making-bed-files/chromatin-status-tads.bed.bgz"
...
# binBedFileInput <- "/home/ali313/Documents/studies/master/umc-project/data/reproducing-fig-3a/making-bed-files/chromatin-status-bins.bed.bgz"
...
# repTimingFileInput <- "/home/ali313/Documents/studies/master/umc-project/data/warm-up/archive/repliseq/bed-union/repliseq_encode_mean_binned.bed.bgz"
...
# repOrientationInputFile <- "/home/ali313/Documents/studies/master/umc-project/data/repli-strand-ori/replication-direction-tableTerritories_Haradhvala_territories.rds.gz"
...
write.table(final_ann_df, file = paste0(out_dir, "/",  sampleID, "/annotated-", sampleID, ".txt"),
