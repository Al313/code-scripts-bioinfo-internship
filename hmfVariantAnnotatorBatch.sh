...
rowNo=$(cat ${wd}/HMF/metadata_whitelisted.tsv | sed -e '1d' | wc -l)
primaryTumorLocs=$(cat ${wd}/HMF/metadata_whitelisted.tsv | sed -e '1d' | cut -d$'\t' -f 7)
sampleNames=$(cat ${wd}/HMF/metadata_whitelisted.tsv | sed -e '1d' | cut -d$'\t' -f 3)
sampleIds=$(cat ${wd}/HMF/metadata_whitelisted.tsv | sed -e '1d' | cut -d$'\t' -f 2)
